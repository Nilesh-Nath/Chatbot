    ...
    <div className='flex flex-col justify-center items-center h-screen my-5'>
        ...
        <form className='flex flex-col border w-1/2'>
            ...
            <div className='flex flex-col border-t px-4 py-4'>
              ...
              <div className='flex justify-between'>
                <div className='flex flex-col w-1/2 mr-4'>
                    ...
                    <input type="text" id="email" name="email" value={user.email} onChange={(e)=>setUser({...user,email:e.target.value})} placeholder='Email' className='border outline-none py-4 px-4 rounded-tr-2xl rounded-bl-2xl mb-5 text-xs bg-transparent'/>
                </div>
                <div className='flex flex-col w-1/2'>
                    <label htmlFor="password" className='text-gray-400 text-sm mb-4'>Password: <span className='text-red-500'>*</span></label>
                    <input type="password" id="password" name="password" value={user.password} onChange={(e)=>setUser({...user,password:e.target.value})} placeholder='Password' className='border outline-none py-4 px-4 rounded-tr-2xl rounded-bl-2xl mb-5 text-xs bg-transparent'/>
                </div> 
              </div>
            </div>
            <div className='flex items-center border-t py-4 border-b justify-end'>
                ...
                <button onClick={(event)=>onLogin(event)} className='flex items-center border px-10 py-4 mr-10 w-40 font-bold bg-black text-white rounded-tr-xl rounded-bl-xl text-sm'>LogIn<IoArrowForwardSharp className='ml-4' /></button>
            </div>
